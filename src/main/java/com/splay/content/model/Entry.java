...
public class Entry {
    ...
    @JsonProperty("peg$contentClassification")
    public String getPegContentClassification() {
        return pegContentClassification;
    }

    @JsonProperty("peg$contentClassification")
    public void setPeg$contentClassification(String pegContentClassification) {
        this.pegContentClassification = pegContentClassification;
    }
